    ...
    <div className='chatBtns'>
      <Row gutter={16}>
        ...
        <Col sm={8} md={5} lg={5} xl={5} xxl={4}>
          {/* <DefaultButton class="btn" name="Not interested" size="large" /> */}
        ...
        <Col sm={8} md={8} lg={8} xl={7} xxl={6}>
          {/* <DefaultButton
            class="btn"
            name="Not accepting new vendors"
            size="large"
          /> */}
          <Button className="btn"  size='large'>
      ...
      <Row gutter={16}>
        <div className="top">
          ...
          <InputGroup compact >
            ...
            {/* <InputSelector options={messageText} selected="Others" /> */}
          </Col>
        </div>
      </Row>
    </div>
