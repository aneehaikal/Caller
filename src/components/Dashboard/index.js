    ...
    render(){
        const companyDetails = [
            ...
            },
            {
              title: (
                <span>
                  <img className="titleImg" src={Bitmap} />
                  Citi Bank
                </span>
              ),
              info: (
                <span>
                  <img className="titleImg" src={Phone} />
              ...
              name1: (
                <span>
                  <img className="titleImg" src={EmailGrey} />
                            ...
                            {companyDetails &&
                                ...
                                <Descriptions.Item key={index} label={item.title}>
                                    ...
                                    <span className="link-desc">
                                        <img src={item.link} /> <span>{item.name1}</span>
                                    </span>
                                    <span className="link-desc">
                                        <img src={item.link2} /> <span>{item.name2}</span>
                                    </span>
                                    <span className="link-desc">
                                        <img src={item.link3} /> <span>{item.name3}</span>
                                    </span>
                                    <img className="imgs" src={item.link4} />
                                    <img className="imgs" src={item.link5} />
                                    </div>
                                </Descriptions.Item>
                                ))}
                            </Descriptions>
